...
from tasks import d1, d2, d3
from task import Task


task_list = [d1.task, d2.task, d3.task]


def PrintResult(task: Task, solution1, solution2):
    print(
        f"Day {task.day}: {task.name} | Answer one: {solution1} | Answer two: {solution2}"
    )
